...
return ( <main className="min-h-screen bg-gradient-to-b from-srm-900 to-srm-700 flex flex-col items-center justify-start px-4 py-8"> <div className="w-full max-w-lg text-center mb-8"> <div className="inline-flex items-center justify-center w-20 h-20 bg-white/10 rounded-full mb-4"> <span className="text-4xl">🩸</span> </div>
...
```
    ...
    <p className="text-srm-300 text-xs mt-1">
      SRM Nagar, Potheri, Kattankulathur-601203
      <br />
  ...
  <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
    <div className="bg-srm-800 px-6 py-4 text-white text-center">
      ...
      <p className="text-srm-200 text-sm mt-1">
        Register Online — Fast & Paperless
      </p>
    </div>
    ...
    <div className="p-6 space-y-4">
      ...
      <InfoRow icon="✅" label="Requirements">
        Age 18–65 • Weight ≥ 45 kg • Feeling healthy • Eaten within 4 hrs
      </InfoRow>
    ...
    <div className="px-6 pb-6 flex flex-col gap-3">
      <Link
        href="/register"
        className="btn-primary text-center block rounded-xl py-4 text-lg"
      >
      ...
      <Link
        href="/auth"
        className="bg-white border-2 border-srm-700 text-srm-700 text-center block rounded-xl py-4 text-lg font-semibold hover:bg-srm-50 transition-colors"
      >
      ...
      <Link
        href="/nurse"
        className="text-center text-sm text-gray-500 hover:text-srm-700 transition-colors mt-2"
      >
        Nurse Portal →
      </Link>
    </div>
...
return ( <div className="flex gap-3"> <span className="text-2xl leading-none mt-0.5">
{icon} </span>


  <div>
    <p className="text-xs font-semibold text-srm-800 uppercase tracking-wide">
      {label}
    </p>
